...
cd fsgrid
git checkout 685bcfcebb22d4638ff931119ec7537f35e1e6b2
cd ..

# Vector class
git clone https://github.com/vectorclass/version1.git vectorclass-v1
cd vectorclass-v1
git checkout f0fd5d2cdbf17c3fd352b860d3a93b4c6f97c7ec
cd ..
git clone https://github.com/vectorclass/add-on.git vectorclass-addon
cd vectorclass-addon
git checkout 600d67becf8144cff4da77b47dd832ce9a98ab2e
cd ..
