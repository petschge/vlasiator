...
# FSgrid
cd fsgrid/
cp fsgrid.hpp $WORKSPACE/libraries${PLATFORM}/include
cd ..
...
cp vector3d/vector3d.h $WORKSPACE/libraries${PLATFORM}/include
cd ..

# DCCRG
cd dccrg
cp *.hpp $WORKSPACE/libraries${PLATFORM}/include
cd ..

# Eigen
cp -r eigen-3.2.8/Eigen $WORKSPACE/libraries${PLATFORM}
